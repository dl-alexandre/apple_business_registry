defmodule AppleBusinessRegistry.TokenCache do
  @moduledoc """
  Caches the Apple Business Registry access token so we don't exchange a new JWT on every call.
  ...
  alias AppleBusinessRegistry.Token
